...
public class dokil implements nation {
  String name = "독일";
  int population = 84316622;
  int likePopulation = 140000;

  enum mainStream {
    KPOP
  };

  String description = "유럽 국가 중 가장 한류가 가장 큰 흐름을 가지고 있는 국가이다. 일례로, 방탄소년단의 콘서트 티켓이 9분만에 3만장 매진되는 사건이 있기도 하였다.";
